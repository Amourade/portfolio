...
export default function moveableMove(e, inheritedEvent) {
    //console.log(inheritedEvent);
    e.preventDefault();
    ...
    window.moveableData.mousePos = {
        x: e.pageX || e.touches[0].pageX,
        y: e.pageY || e.touches[0].pageY,
    };
    window.moveableData.mouseDiff = {
        x:
            window.moveableData.mouseStartDrag.x -
            window.moveableData.mousePos.x,
        y:
            window.moveableData.mouseStartDrag.y -
            window.moveableData.mousePos.y,
    };
